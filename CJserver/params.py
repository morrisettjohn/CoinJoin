...
START_PROCESS, SELECT_OPTIONS, GET_JOIN_DATA, COLLECT_INPUTS, COLLECT_SIGS, ISSUE_TX, REQUEST_WTX, REQUEST_NONCE, EXIT = range(9) #different states for a CoinJoin
MIN_USER_BOUND = 2
MAX_USER_BOUND = 20
