...
const destinationaddr1S = "X-fuji1ywknekcr6rkekg9g996dsnsdg20wmvwhpsmup6"
...
const destinationaddr2S = "X-fuji1tunzyk0v8fw5ee73uzdedrtunf26936fy9wg48"
...
const destinationaddr3S = "X-fuji12jwy0ctuankcamu0qv0dcy95pxsr578ju7t7qe"
...
const destinationaddr4S = "X-fuji1ga8cr9eu7fq9x6f7zvwq26xmm4vdmdg7zrveav"
...
const destinationaddr1R = "X-fuji13a3dm204mh9hfjx3ajpk33cchgszh2qry97ml9"
...
const destinationaddr2R = "X-fuji1d6fetyekv4ec5enm9ltuxrd6n70ng04rpxq443"
...
const destinationaddr3R = "X-fuji10a7tx3xl2cyp3g60d68zh80tzen0lwxd548u82"
...
const destinationaddr4R = "X-fuji1408364q97l7x6hjjqdmkjl09hjn5r3uyqwfa9l"
...
const test1S = [destinationaddr1S, pubaddr1S, privatekey1S]
const test2S = [destinationaddr2S, pubaddr2S, privatekey2S]
const test3S = [destinationaddr3S, pubaddr3S, privatekey3S]
const test4S = [destinationaddr4S, pubaddr4S, privatekey4S]
const test1R = [destinationaddr1R, pubaddr1R, privatekey1R]
const test2R = [destinationaddr2R, pubaddr2R, privatekey2R]
const test3R = [destinationaddr3R, pubaddr3R, privatekey3R]
const test4R = [destinationaddr4R, pubaddr4R, privatekey4R]
...
const main = async(): Promise<any> => {
    const txdata = await sendutxodata(joinid, avaxAssetID, inputamount, outputamount, testdata[0], testdata[1], testdata[2])
}
main()