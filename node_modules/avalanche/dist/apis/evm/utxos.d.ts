...
export declare class UTXOSet extends StandardUTXOSet<UTXO> {
    ...
    /**
      ...
      *
      */
    buildImportTx: (networkID: number, blockchainID: Buffer, toAddress: string, fromAddresses: Buffer[], atomics: UTXO[], sourceChain?: Buffer, fee?: BN, feeAssetID?: Buffer) => UnsignedTx;
    /**
