...
var utils$1 = require('avalanche/dist/utils');
...
var keychain = require('avalanche/dist/apis/evm/keychain');
var avm = require('avalanche/dist/apis/avm');
var common$1 = require('avalanche/dist/common');
var platformvm = require('avalanche/dist/apis/platformvm');
var tx = require('@ethereumjs/tx');
var EthereumjsCommon = require('@ethereumjs/common');
var moment = require('moment');
var keychain$1 = require('avalanche/dist/apis/avm/keychain');
...
var MainnetConfig = {
    ...
    // @ts-ignore
    pChainID: utils$1.Defaults.network[1]['P']['blockchainID'],
    // @ts-ignore
    cChainID: utils$1.Defaults.network[1]['C']['blockchainID'],
    // @ts-ignore
...
var TestnetConfig = {
    ...
    // @ts-ignore
    pChainID: utils$1.Defaults.network[5]['P']['blockchainID'],
    // @ts-ignore
    cChainID: utils$1.Defaults.network[5]['C']['blockchainID'],
    // @ts-ignore
...
var LocalnetConfig = {
    ...
    networkID: 12345,
    // @ts-ignore
    xChainID: utils$1.Defaults.network[12345]['X']['blockchainID'],
    // @ts-ignore
    pChainID: utils$1.Defaults.network[12345]['P']['blockchainID'],
    // @ts-ignore
    cChainID: utils$1.Defaults.network[12345]['C']['blockchainID'],
    // @ts-ignore
...
var AVMWebSocketProvider = /** @class */ (function () {
    function AVMWebSocketProvider(wsUrl) {
        var _this = this;
        this.isConnected = false;
        this.wallets = [];
        this.boundHandler = function () { return _this.onWalletAddressChange(); };
     ...
     */
    AVMWebSocketProvider.prototype.trackWallet = function (wallet) {
    ...
    AVMWebSocketProvider.prototype.onWalletAddressChange = function () {
        this.updateFilterAddresses();
    };
    AVMWebSocketProvider.prototype.removeWallet = function (w) {
        if (!this.wallets.includes(w)) {
            return;
        }
        var index = this.wallets.indexOf(w);
        this.wallets.splice(index, 1);
        w.off('addressChanged', this.boundHandler);
    };
    AVMWebSocketProvider.prototype.setEndpoint = function (wsUrl) {
        var _this = this;
        this.socket.close();
        this.socket = new Sockette__default['default'](wsUrl, {
            onopen: function () {
    ...
    AVMWebSocketProvider.prototype.clearFilter = function () {
     ...
     */
    AVMWebSocketProvider.prototype.updateFilterAddresses = function () {
        if (!this.isConnected) {
            return;
        }
        var wallets = this.wallets;
        var addrs = [];
        for (var i = 0; i < wallets.length; i++) {
            var w = wallets[i];
            var externalAddrs = w.getExternalAddressesX();
            var addrsLen = externalAddrs.length;
            var startIndex = Math.max(0, addrsLen - FILTER_ADDRESS_SIZE);
            var addAddrs = externalAddrs.slice(startIndex);
            addrs.push.apply(addrs, addAddrs);
        }
        var pubsub = new avalanche$1.PubSub();
        var bloom = pubsub.newBloom(FILTER_ADDRESS_SIZE);
        this.socket.send(bloom);
    ...
    AVMWebSocketProvider.prototype.updateWalletBalanceX = function () {
        this.wallets.forEach(function (w) {
            w.updateUtxosX();
        });
    };
    AVMWebSocketProvider.prototype.onOpen = function () {
        this.isConnected = true;
        this.updateFilterAddresses();
    };
    AVMWebSocketProvider.prototype.onMessage = function () {
        this.updateWalletBalanceX();
    };
    AVMWebSocketProvider.prototype.onClose = function () {
        this.isConnected = false;
    };
    AVMWebSocketProvider.prototype.onError = function () { };
    return AVMWebSocketProvider;
}());
...
var EVMWebSocketProvider = /** @class */ (function () {
    function EVMWebSocketProvider(wsUrl) {
        this.wallets = [];
        var provider = new ethers.ethers.providers.WebSocketProvider(wsUrl);
        this.provider = provider;
        this.wsUrl = wsUrl;
        this.addListeners();
    }
    EVMWebSocketProvider.prototype.setEndpoint = function (wsUrl) {
    ...
    EVMWebSocketProvider.prototype.trackWallet = function (wallet) {
        if (this.wallets.includes(wallet)) {
            return;
        }
        this.wallets.push(wallet);
    };
    EVMWebSocketProvider.prototype.removeWallet = function (wallet) {
        if (!this.wallets.includes(wallet)) {
            return;
        }
    ...
    EVMWebSocketProvider.prototype.destroyConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.provider._websocket.onclose = function () { };
                        return [4 /*yield*/, this.provider.destroy()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    EVMWebSocketProvider.prototype.reconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            var wsProvider;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, this.destroyConnection()];
                    case 1:
                        // Clear the current onclose handler so that we dont attempt a reconnection
                        _a.sent();
                        wsProvider = new ethers.ethers.providers.WebSocketProvider(this.wsUrl);
    ...
    EVMWebSocketProvider.prototype.addListeners = function () {
        var _this = this;
        ...
        var defaultOnOpen = provider._websocket.onopen;
        var defaultOnClose = provider._websocket.onclose;
        provider._websocket.onopen = function (ev) {
            if (defaultOnOpen)
                defaultOnOpen(ev);
        };
        provider._websocket.onclose = function (ev) {
            if (defaultOnClose)
                defaultOnClose(ev);
            setTimeout(function () {
                _this.reconnect();
    ...
    EVMWebSocketProvider.prototype.removeListeners = function () {
        this.provider.off('block', this.onBlock);
    };
    EVMWebSocketProvider.prototype.onBlock = function () {
    ...
    return EVMWebSocketProvider;
}());

var WebsocketProvider = /** @class */ (function () {
    function WebsocketProvider(avmEndpoint, evmEndpoint) {
        this.avmProvider = new AVMWebSocketProvider(avmEndpoint);
        this.evmProvider = new EVMWebSocketProvider(evmEndpoint);
    }
    WebsocketProvider.fromActiveNetwork = function () {
        return WebsocketProvider.fromNetworkConfig(activeNetwork);
    };
    WebsocketProvider.fromNetworkConfig = function (config) {
        var evm = wsUrlFromConfigEVM(config);
        var avm = wsUrlFromConfigX(config);
        return new WebsocketProvider(avm, evm);
    };
    WebsocketProvider.prototype.setEndpoints = function (avmEndpoint, evmEndpoint) {
        this.avmProvider.setEndpoint(avmEndpoint);
        this.evmProvider.setEndpoint(evmEndpoint);
    };
    WebsocketProvider.prototype.setNetwork = function (config) {
        var evm = wsUrlFromConfigEVM(config);
        var avm = wsUrlFromConfigX(config);
        this.setEndpoints(avm, evm);
    };
    WebsocketProvider.prototype.trackWallet = function (wallet) {
        this.avmProvider.trackWallet(wallet);
        this.evmProvider.trackWallet(wallet);
    };
    WebsocketProvider.prototype.removeWallet = function (wallet) {
...
var Erc20Token = /** @class */ (function () {
    ...
    Erc20Token.prototype.toData = function () {
        return this.data;
    };
...
var validateAddress = function (address) {
    try {
        bintools$1.stringToAddress(address);
        return true;
    }
    catch (error) {
...
Big__default['default'].prototype.toLocaleString = function (toFixed) {
...
function avaxCtoX(amount) {
    var tens = new avalanche$1.BN(10).pow(new avalanche$1.BN(9));
...
function bigToLocaleString(bigVal, decimals) {
    if (decimals === void 0) { decimals = 9; }
...
var payloadtypes = utils$1.PayloadTypes.getInstance();
...
var erc20Store = {};
var erc20StoreCustom = {};
function getErc20Store() {
    return __assign({}, erc20Store);
}
function getErc20StoreCustom() {
    return __assign({}, erc20StoreCustom);
}
/**
 ...
 */
function addErc20Token(address, store) {
    if (store === void 0) { store = erc20StoreCustom; }
    return __awaiter(this, void 0, void 0, function () {
        var existing, data, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    existing = erc20Store[address] || erc20StoreCustom[address];
                    if (existing) {
...
function addErc20TokenFromData(data, store) {
    if (store === void 0) { store = erc20StoreCustom; }
    var address = data.address;
    var existing = erc20Store[address] || erc20StoreCustom[address];
    if (existing) {
        return existing;
    }
    var token = new Erc20Token(data);
    store[address] = token;
    return token;
}
...
function getErc20Token(address) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    storeItem = erc20Store[address] || erc20StoreCustom[address];
                    if (!storeItem) return [3 /*break*/, 1];
                    return [2 /*return*/, storeItem];
                case 1: return [4 /*yield*/, addErc20Token(address)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function balanceOf(address) {
    return __awaiter(this, void 0, void 0, function () {
        var balance, store, _a, _b, _i, tokenAddress, token, bal;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    balance = {};
                    store = __assign(__assign({}, erc20Store), erc20StoreCustom);
                    _a = [];
                    for (_b in store)
                        _a.push(_b);
                    _i = 0;
...
var index$1 = /*#__PURE__*/Object.freeze({
    ...
    addErc20TokenFromData: addErc20TokenFromData,
    getErc20Token: getErc20Token,
    balanceOf: balanceOf,
    getContractData: getContractData,
    getErc20Store: getErc20Store,
    getErc20StoreCustom: getErc20StoreCustom,
...
var EvmWalletReadonly = /** @class */ (function () {
    ...
    EvmWalletReadonly.prototype.getAddressBech32 = function () {
        var keypair = new keychain.KeyPair(avalanche.getHRP(), 'C');
        var addr = keypair.addressFromPublicKey(avalanche$1.Buffer.from(this.publicKey));
...
var EvmWallet = /** @class */ (function (_super) {
    ...
    EvmWallet.prototype.getPrivateKeyBech = function () {
        return "PrivateKey-" + bintools.cb58Encode(avalanche$1.Buffer.from(this.privateKey));
    };
            ...
            switch (_a.label) {
                case 0:
                    ...
                    for (i = 0; i < quantity; i++) {
                        owner = new common$1.OutputOwners([addrBuf]);
                        owners.push(owner);
                    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    avaxAssetIDStr = bintools.cb58Encode(avaxAssetIDBuf);
...
function getStakeForAddresses(addrs) {
    return __awaiter(this, void 0, void 0, function () {
        var data, chunk, remainingChunk, chunkData, chunkStake, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
...
var WalletProvider = /** @class */ (function () {
     ...
     */
    WalletProvider.prototype.getBaseAddress = function () {
     ...
     *  */
    WalletProvider.prototype.updateUtxosX = function () {
        return __awaiter(this, void 0, void 0, function () {
            var addresses, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.utxosX = _b.sent();
                        return [4 /*yield*/, this.updateUnknownAssetsX()];
                    case 2:
                        _b.sent();
                        this.updateBalanceX();
     ...
     */
    WalletProvider.prototype.updateUtxosP = function () {
        return __awaiter(this, void 0, void 0, function () {
            var addresses, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    WalletProvider.prototype.updateBalanceERC20 = function () {
        return __awaiter(this, void 0, void 0, function () {
            var newBal, balNow, strNewBal, strBalNow;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, balanceOf(this.getAddressC())];
                    case 1:
                        newBal = _a.sent();
                        balNow = this.balanceERC20;
                        strNewBal = JSON.stringify(newBal);
                        strBalNow = JSON.stringify(balNow);
    ...
    WalletProvider.prototype.updateUnknownAssetsX = function () {
        return __awaiter(this, void 0, void 0, function () {
            var utxos, i, utxo, assetIdBuff, assetId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        assetId = bintools.cb58Encode(assetIdBuff);
                        return [4 /*yield*/, getAssetDescription(assetId)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    WalletProvider.prototype.getBalanceX = function () {
     ...
     */
    WalletProvider.prototype.getAvaxBalance = function () {
        var X = this.getAvaxBalanceX();
        var P = this.getAvaxBalanceP();
        var C = this.getAvaxBalanceC();
        return {
            X: X,
            P: P,
            C: C,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        utxoAddrs = utxoSet.getAddresses().map(function (addr) { return bintools.addressToString(hrp, 'X', addr); });
                        fromAddrs = utxoAddrs;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        hrp = avalanche.getHRP();
                        utxoAddrs = utxoSet.getAddresses().map(function (addr) { return bintools.addressToString(hrp, 'P', addr); });
                        ownerAddrs = utxoAddrs;
...
var HdScanner = /** @class */ (function () {
    ...
    HdScanner.prototype.getAddressForIndex = function (index, chainId) {
        ...
        var hrp = utils$1.getPreferredHRP(avalanche.getNetworkID());
        var keypair = new keychain$1.KeyPair(hrp, chainId);
                    ...
                    case 2:
                        ...
                        for (i = 0; i < addrsX.length - INDEX_RANGE; i++) {
                            ...
                            for (n = 0; n < INDEX_RANGE; n++) {
                                ...
                                addrBuf = bintools.parseAddress(addr, 'X');
...
var HDWalletAbstract = /** @class */ (function (_super) {
    ...
    HDWalletAbstract.prototype.updateUtxosX = function () {
        return __awaiter(this, void 0, void 0, function () {
            var utxosX, utxoAddrs, utxoAddrsStr, addrExternalX, addrInternalX, isAddrChange;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.updateUtxosX.call(this)];
                    case 1:
                        utxosX = _a.sent();
    ...
    HDWalletAbstract.prototype.updateUtxosP = function () {
        return __awaiter(this, void 0, void 0, function () {
            var utxosP, utxoAddrs, utxoAddrsStr, addrExternalP;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.updateUtxosP.call(this)];
                    case 1:
                        utxosP = _a.sent();
...
var MnemonicWallet = /** @class */ (function (_super) {
     ...
     */
    MnemonicWallet.prototype.getEvmPrivateKeyHex = function () {
    ...
    //function that returns the signature for a utx.  Added for the coinjoin project
    MnemonicWallet.prototype.getSigFromUTX = function (msgBuf, index){
        var key = this.externalScan.getKeyForIndexX(index)
        return Buffer.from(key.sign(msgBuf))
...
var SingletonWallet = /** @class */ (function (_super) {
    ...
    function SingletonWallet(privateKey) {
        ...
        var pkBuf = bintools.cb58Decode(privateKey.split('-')[1]);
        _this.keyBuff = pkBuf;
    ...
    SingletonWallet.fromPrivateKey = function (key) {
        return new SingletonWallet(key);
    };
    SingletonWallet.fromEvmKey = function (key) {
        var keyBuff = bintools.cb58Encode(avalanche$1.Buffer.from(key, 'hex'));
     ...
     * Returns the derived private key used by the EVM wallet.
     */
    SingletonWallet.prototype.getEvmPrivateKeyHex = function () {
        return this.evmWallet.getPrivateKeyHex();
    };
    ...
    LedgerWallet.prototype.getCredentials = function (unsignedTx, paths, sigMap, chainId) {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            for (var j = 0; j < sigidxs.length; j++) {
                ...
                var sig = new common$1.Signature();
...
var PublicMnemonicWallet = /** @class */ (function (_super) {
    __extends(PublicMnemonicWallet, _super);
    /**
     *
     * @param xpubAVM of derivation path m/44'/9000'/0'
     * @param xpubEVM of derivation path m/44'/60'/0'
     */
    function PublicMnemonicWallet(xpubAVM, xpubEVM) {
        var _this = this;
        var avmAcct = HDKey__default['default'].fromExtendedKey(xpubAVM);
        var evmAcct = HDKey__default['default'].fromExtendedKey(xpubEVM).derive('m/0/0');
        _this = _super.call(this, avmAcct) || this;
        _this.type = 'xpub';
        _this.evmWallet = new EvmWalletReadonly(ethereumjsUtil.importPublic(evmAcct.publicKey));
        return _this;
    }
    PublicMnemonicWallet.prototype.getAddressC = function () {
        return this.evmWallet.getAddress();
    };
    PublicMnemonicWallet.prototype.getEvmAddressBech = function () {
        return this.evmWallet.getAddressBech32();
    };
    //@ts-ignore
    PublicMnemonicWallet.prototype.signC = function (tx) {
        throw new Error('Not supported.');
    };
    //@ts-ignore
    PublicMnemonicWallet.prototype.signEvm = function (tx) {
        throw new Error('Not supported.');
    };
    //@ts-ignore
    PublicMnemonicWallet.prototype.signP = function (tx) {
        throw new Error('Not supported.');
    };
    //@ts-ignore
    PublicMnemonicWallet.prototype.signX = function (tx) {
        throw new Error('Not supported.');
    };
    return PublicMnemonicWallet;
}(HDWalletAbstract));
