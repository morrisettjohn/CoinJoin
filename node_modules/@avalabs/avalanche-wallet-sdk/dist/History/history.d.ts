import { AVMHistoryItemType, iHistoryEVMTx, ITransactionData, ITransactionDataEVM } from "./types";
/**
...
export declare function getTransactionSummary(tx: ITransactionData, walletAddrs: string[], evmAddress: string): Promise<AVMHistoryItemType>;
